...
#ifndef NephilimSoundFile_h__
#define NephilimSoundFile_h__
...
private :
	...
	bool openReadInternal(File& stream);
	...
	File*        m_ownedStream;  ///< When the sound file creates the file stream itself
