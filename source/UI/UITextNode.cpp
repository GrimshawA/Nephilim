...
, m_vertical(Center)
{
//	component_id = UIController::TextComponent;
	color = Color(151,151,151);
}


UITextNode::UITextNode(const String& text, Alignment horizontal, Alignment vertical)
: m_string(text)
...
void UITextNode::onPropertySet(const StringList& targetObject, const String& value)
{
