...
void ATilemapComponent::generateTiles(Tilemap::Layer* tileLayer, const String& destLayer)
{
...
void ATilemapComponent::generateCubes(Tilemap::Layer* tileLayer, const String& destLayer)
{
