...
ASkeletalMeshComponent::ASkeletalMeshComponent()
{
...
void ASkeletalMeshComponent::loadAnimation(const String& filename, const String& skeletonName)
{
...
void ASkeletalMeshComponent::update(const Time& deltaTime)
{
