...
// row major matrix
// first 4 elements in the 1D array are a single row, not a single column

// when equal to mine = bad

// coefficients() returns a row major array (first four values are the first row)
// my .get() returns a column major array (first four values are the first column)
