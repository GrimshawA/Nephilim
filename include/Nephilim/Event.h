...
/**
	\ingroup Core
	\class Keyboard
	\brief Holds information about keyboard state
*/
...
/**
	\ingroup Core
	\class Joystick
	\brief Holds information about joystick state
*/
...
/**
	\ingroup Core
	\class Event
	\brief Holds information about an event generated by the operating system
*/
