...
#ifndef NEPHILIM_TRANSFORMABLE
#define NEPHILIM_TRANSFORMABLE
...
public :
    ...
    /// \code
    /// sf::Vec2f pos = object.getPosition();
    ...
    /// Thus, it is equivalent to the following code:
    /// \code
    /// sf::Vec2f scale = object.getScale();
...
private :
    ...
    // Member data
    ////////////////////////////////////////////////////////////
    Vec2f          m_origin;                     ///< Origin of translation/rotation/scaling of the object
